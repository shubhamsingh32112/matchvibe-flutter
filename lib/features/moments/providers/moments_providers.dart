...
enum MomentsFeedTab { forYou, following }

final momentsFeedTabProvider = StateProvider<MomentsFeedTab>(
  (ref) => MomentsFeedTab.forYou,
);
...
class ForYouFeedNotifier extends AsyncNotifier<List<MomentFeedItem>> {
  String? _nextCursor;
...
final forYouFeedProvider =
    AsyncNotifierProvider<ForYouFeedNotifier, List<MomentFeedItem>>(
